...
_instruction = schema_manager.generate_system_prompt(
    role_description=(
        ...
        'services, and resolution status. Always respond with A2UI JSON.'
    ),
    workflow_description=(
        ...
        '5-8 incidents. Always wrap your A2UI JSON in <a2ui-json> and </a2ui-json> '
        'tags. The JSON should be a list of A2UI messages. Include createSurface, '
